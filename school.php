  ...
  <body>
	<nav class="navbar navbar-default ">
	  <div class="container-fluid"> 
		...
		<a class="navbar-brand"  href="#" ><img style="max-width:100px; margin-top: -15px; max-height:50px;" alt="Aicte" src="aicte.png"></a>		
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<li><a href="school.php">School Level Report</a></li>
				<li  class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" >Higher Education Level Report</a>
					<ul class="dropdown-menu" >
						<li class="list"><a href="university.php">Unversities</a></li>
						<li class="list"><a href="institute.php">Institutions/colleges</a></li>
						<li class="list"><a href="teacher.php">Teachers</a></li>
						<li class="list"><a href="student.php">Students</a></li>
				  </ul>
				</li>
			</ul>
	...
	<center> <h1 style="border-radius:4px"><b>DATA REPRESENTATION</b></h1><center>
	
	<div id="graph" style="margin-left:14px;  margin-right: 15px; width:97.70%; margin-top:10px; display:block;" >
		...
		<br>
		<center><B><input style="border-radius:0px; padding: 10px 24px; font-size: 12.5px; background-color:#BAB1B0; color:#000000; " type="submit" name="submit" value="Submit"></input></B></center>                              
							<!--Form group end-->
							</div>
						<br>						
				</form>	
			...
			<center> <label style="background-color:lightgreen; border-radius:4px"></label><center>
                                ...
                                <div id="dataTables1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									...
									<div class="row">
										...
										<table id="employee-grid" 
											   style='display: block; overflow-x: scroll; white-space: nowrap;' 
											   class='table paging table-striped table-bordered ' 
											   class="display" 
											   width="100%">
												<thead>
													<tr>
