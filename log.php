...
<a class="navbar-brand"  href="#" ><img style="max-width:100px; margin-top: -15px; max-height:50px;" alt="Aicte"        src="aicte.png"></a>		</div>
  ...
  <!-- /.container-fluid --> 
     ...
     <!-- /.navbar-collapse --> 		<div class="container">
    <div class="row" style="padding-top:65px">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Login to Continue</h1>
            <div class="account-wall">
			<h1 class="text-center login-title">Nodal Education Officer Login</h1>
                <img class="profile-img" src="user.png" alt="profile image">

                <form  action="logincheck.php" class="form-signin" method="post">
                <input type="text" class="form-control" placeholder="User Id" required name="Username" autofocus>
                <input type="password" class="form-control" placeholder="Password" required name="Password">
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit" id="btn" >
                    Log in</button>
                
                    <input type="checkbox" value="remember-me" class="pull-left">
                    Remember me
