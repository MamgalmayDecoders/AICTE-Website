...
<a class="navbar-brand"  href="#" ><img style="max-width:100px; margin-top: -15px; max-height:50px;" alt="Aicte"        src="aicte.png"></a>		</div>
  ...
  <!-- /.container-fluid --> 
</nav><br><div id="graph" style="margin-left: 14px;  margin-right: 15px; width:97.70%; margin-top:50px; display:block;" >
   ...
   <form action="" method="get" style="text-align:center; background-color:#E7E2E1;">
							...
							<label for="year">Year</label>
                                           ...
                                           <label for="Enrollment Type">Catagories</label>
											...
											<option value="State wise" id="State wise">State wise</option>
                                                <option value="Management wise" id="Management wise">Management wise</option>
                                                <option value="University wise" id="University wise">University wise</option>
                                                <option value="Intstitutions wise" id="Intstitutions wise">Intstitutions wise</option>
												<option value="University Type wise" id="University Type wise">University Type wise</option>
												<option value="Level wise" id="Level wise">Level wise (In Institutes)</option>
												<option value="Post wise" id="Post wise">Post wise (University)</option>
												<option value="post wise type" id="post wise type">Post wise (University Type)</option>
												<option value="Post wise institutes" id="Post wise institutes">Post wise (Institutes)</option>
												<option value="Post wise institutes" id="Post wise institutes">Minority wise (Institutes)</option>
                                                </select>
...
<select class="form-control input-sm" name="val4" id="val4">
	...
	<option value="Muslim" id="Muslim">Muslim</option>
    </select>
