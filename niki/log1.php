    ...
    <div class="row" style="padding-top:65px">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <input type="text" class="form-control" placeholder="User Id" required name="Username">
                <input type="password" class="form-control" placeholder="Password" required name="Password">
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit" id="btn" onclick="window.location='http://localhost/final/final/admin.php'">
                    Log in</button>
