...
<head>
  <meta charset="UTF-8">
  <title>Morris.js charts - simple examples</title>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="jumbotron">
      <table width="100%" text-align="center"><tr>
        <td>
        <table><tr><td>     <img src="img/imageedit_2_7100810043.png" width="150" height="100" alt=""/></td><td>
     <center><h2 class="text-center" style="margin-left:240px;"><font color="#FD0307">Govt. of India</font><br>AICTE EDUCATIONAL SURVEY</h2></center></td></tr></table></td>
       </tr>
...
<div class="w3-content w3-section" style="max-width:500px">
  <img class="mySlides" src="image/img1.jpg" style="width:1000px;height:400px">
  <img class="mySlides" src="image/img2.jpg" style="width:1000px;height:400px">
  <img class="mySlides" src="image/img3.jpg" style="width:1000px;height:400px">
    <img class="mySlides" src="image/img4.png" style="width:1000px;height:400px">
</div></td></div></tr>
       <tr><td>  </td></tr></table>
    </div>
...
<div class="container">
  <div class="row">
   ...
   <div  class="col-sm-6 text-center">
       <H4><label class="label label-success">Number Of Recognised Educational Institutions Of Higher Learning,<BR>(All India) upto 2010-11</label></H4>
      <div id="pie-charta" ></div>
	    </div>
		
  <div  class="col-sm-6 text-center">
       <H4><label class="label label-success">Expenditure on Education By Centre And <BR>State Governments</label></H4>
      <div id="pie-chartb" ></div>
	  </div>
	  <div  class="col-sm-6 text-center">
       <H4><label class="label label-success">Gross Budgetary Support For Education Sector<BR>In The Twelfth Plan</label></H4>
      <div id="pie-chartc" ></div>
	  </div>
	  
	  <div  class="col-sm-6 text-center">
       <H4><label class="label label-success">Growth of Higher Education System</label></H4>
