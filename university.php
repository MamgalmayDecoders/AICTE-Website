  ...
  <!-- /.container-fluid --> 
   ...
   <form action="" method="get" style="text-align:center; background-color:#E7E2E1;">
							...
							<label for="year">Year</label>
                                           ...
                                           <label for="Enrollment Type">Details of</label>
                                            <select class="form-control" name="val2" id="val2">
											<option value="list univer" id="list univer">List of all Universities</option>
                                                <option value="list inst" id="list inst">List of all Institutes</option>
...
<option  value="INDIA">India</option>
                                                ...
                                                <label for="level">Womens only</label>
<select class="form-control input-sm" name="val4" id="val4">
	<option selected="" value="" id="">-----No-----</option>
    <option value="womens" id="womens">Yes</option>
